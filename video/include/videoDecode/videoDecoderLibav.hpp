    ...
    namespace Video {
        ...
        class LIBTRAINSIM_EXPORT_MACRO videoDecoderLibav : public videoDecoderBase {
          ...
          public:
             ...
             */
            explicit videoDecoderLibav(std::filesystem::path videoFile, std::shared_ptr<SimpleGFX::logger> _logger, uint64_t start_frame = 0, uint64_t _seekCutoff = 200, uint64_t threadCount = 0);
