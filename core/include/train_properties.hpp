    ...
    namespace core {
        ...
        class LIBTRAINSIM_EXPORT_MACRO train_properties {
          ...
          public:
             ...
             * It is used to calulate the air drag force of the train, by multiplying it with the dynamic pressure using the current
             * velocity. This calculation is done by the calculateDrag function, which also adds the rolling resistance.
